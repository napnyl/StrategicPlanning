...
namespace StPlanning.UserControls
{
    ...
    public partial class BscLevel3 : System.Windows.Forms.Form
    {
        ...
        {
            //Se ordena la tabla de entrada para manejar tipo empresa privada: Financiero, Cliente, Proceso y Aprendizaje.
        ...
        {
            ((DevExpress.XtraBars.Ribbon.RibbonControl)(this.Parent.TopLevelControl.Controls["ribbonControl1"])).Items["btnBscLevel3"].Enabled = true;
            dtBscLevel3 = new DataTable();
            Main.projectSaved = false;
        }
        ...
        private void btnExportExcel_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            saveDialog.FileName = "BSC_Nivel3_" + DateTime.Now.ToString("yyyyMMdd");
