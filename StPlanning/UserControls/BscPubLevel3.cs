...
namespace StPlanning.UserControls
{
    ...
    public partial class BscPubLevel3 : System.Windows.Forms.Form
    {
        public static DataTable dtBscLevel3 = new DataTable();
        ...
        public BscPubLevel3(DataTable dt, int typeIn)
        {
            InitializeComponent();
        ...
        private void MatrixManagerSt_Load(object sender, EventArgs e)
        {
            if (!fromDb)
            {
                ...
                {
                    if (XtraMessageBox.Show("¿Desea borrar la anterior tabla BCS Nivel 3 y volver a generar una nueva?", "Confirmación", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
                    {
                        dtBscLevel3 = new DataTable();
                        CreateManagerStMatrix();
                        stShown = true;
                    }
                    else
        ...
        {
            int rowCount = 0;
            foreach (DataRow row in dtBscLevel3.Rows)
            {
                if (dtBscLevel3.Rows.IndexOf(row) > 2)
                {
                    rowCount++;

                    if (rowCount <= dt.Rows.Count)
                    {
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][5] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][5] != null)
                        {
                            row["col2"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][5].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][7] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][7] != null)
                        {
                            row["col4"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][7].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][8] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][8] != null)
                        {
                            row["col5"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][8].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][9] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][9] != null)
                        {
                            row["col6"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][9].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][10] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][10] != null)
                        {
                            row["col7"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][10].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][11] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][11] != null)
                        {
                            row["col8"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][11].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][12] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][12] != null)
                        {
                            row["col9"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][12].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][13] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][13] != null)
                        {
                            row["col10"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][13].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][14] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][14] != null)
                        {
                            row["col11"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][14].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][15] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][15] != null)
                        {
                            row["col12"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][15].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][16] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][16] != null)
                        {
                            row["col13"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][16].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][17] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][17] != null)
                        {
                            row["col14"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][17].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][18] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][18] != null)
                        {
                            row["col15"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][18].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][19] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][19] != null)
                        {
                            row["col16"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][19].ToString();
                        }
                        if (dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][20] != DBNull.Value && dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][20] != null)
                        {
                            row["col17"] = dt.Rows[dtBscLevel3.Rows.IndexOf(row) - 3][20].ToString();
                        }
                    }
                }
            }
        ...
        private void CreateManagerStMatrix()
        {
            ...
            {
                dtBscLevel3 = GroupStrategies(MatrixLevel3.dtLevel3);
                gridControl1.DataSource = dtBscLevel3;
        ...
        {
            ((DevExpress.XtraBars.Ribbon.RibbonControl)(this.Parent.TopLevelControl.Controls["ribbonControl1"])).Items["btnPublicBscLevel3"].Enabled = true;
            dtBscLevel3 = new DataTable();
            Main.projectSaved = false;
        }
        ...
        public void RefreshManagerStMatrix()
        {
            if (MatrixLevel3.dtLevel3 != null && MatrixLevel3.dtLevel3.Rows.Count > 0)
            {
                DataTable dtBscLevel3Temp = dtBscLevel3.Copy();
                dtBscLevel3 = new DataTable();
                dtBscLevel3 = GroupStrategies(MatrixLevel3.dtLevel3);

                foreach (DataRow row in dtBscLevel3.Rows)
                {
                    if (dtBscLevel3.Rows.IndexOf(row) <= (dtBscLevel3Temp.Rows.Count - 1))
                    {
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][1] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][1] != null)
                        {
                            row["col2"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][1].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][3] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][3] != null)
                        {
                            row["col4"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][3].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][4] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][4] != null)
                        {
                            row["col5"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][4].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][5] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][5] != null)
                        {
                            row["col6"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][5].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][6] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][6] != null)
                        {
                            row["col7"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][6].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][7] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][7] != null)
                        {
                            row["col8"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][7].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][8] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][8] != null)
                        {
                            row["col9"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][8].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][9] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][9] != null)
                        {
                            row["col10"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][9].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][10] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][10] != null)
                        {
                            row["col11"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][10].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][11] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][11] != null)
                        {
                            row["col12"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][11].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][12] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][12] != null)
                        {
                            row["col13"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][12].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][13] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][13] != null)
                        {
                            row["col14"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][13].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][14] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][14] != null)
                        {
                            row["col15"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][14].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][15] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][15] != null)
                        {
                            row["col16"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][15].ToString();
                        }
                        if (dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][16] != DBNull.Value && dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][16] != null)
                        {
                            row["col17"] = dtBscLevel3Temp.Rows[dtBscLevel3.Rows.IndexOf(row)][16].ToString();
                        }
                    }
                }
        ...
        private void btnExportExcel_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            saveDialog.FileName = "BSC_Pub_Nivel3_" + DateTime.Now.ToString("yyyyMMdd");
