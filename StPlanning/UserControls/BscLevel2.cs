...
namespace StPlanning.UserControls
{
    ...
    public partial class BscLevel2 : System.Windows.Forms.Form
    {
        ...
        {
            ((DevExpress.XtraBars.Ribbon.RibbonControl)(this.Parent.TopLevelControl.Controls["ribbonControl1"])).Items["btnBscLevel2"].Enabled = true;
            dtBscLevel2 = new DataTable();
            Main.projectSaved = false;
        }
        ...
        private void btnExportExcel_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            saveDialog.FileName = "BSC_Nivel2_" + DateTime.Now.ToString("yyyyMMdd");
