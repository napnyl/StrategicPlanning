...
namespace StPlanning.UserControls
{
    ...
    public partial class BscPubLevel1 : System.Windows.Forms.Form
    {
        ...
        public BscPubLevel1(DataTable dt, int typeIn)
        {
            InitializeComponent();
        ...
        {
            ((DevExpress.XtraBars.Ribbon.RibbonControl)(this.Parent.TopLevelControl.Controls["ribbonControl1"])).Items["btnPublicBscLevel1"].Enabled = true;
            dtBscLevel1 = new DataTable();
            Main.projectSaved = false;
        }
        ...
        private void btnExportExcel_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            saveDialog.FileName = "BSC_Pub_Nivel1_" + DateTime.Now.ToString("yyyyMMdd");
