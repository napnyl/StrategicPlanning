...
namespace StPlanning.UserControls
{
    ...
    public partial class BscLevel4 : System.Windows.Forms.Form
    {
        ...
        {
            ((DevExpress.XtraBars.Ribbon.RibbonControl)(this.Parent.TopLevelControl.Controls["ribbonControl1"])).Items["btnBscLevel4"].Enabled = true;
            dtBscLevel4 = new DataTable();
            Main.projectSaved = false;
        }
        ...
        private void btnExportExcel_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            saveDialog.FileName = "BSC_Nivel4_" + DateTime.Now.ToString("yyyyMMdd");
